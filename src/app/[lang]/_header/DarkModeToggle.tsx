...
export default function DarkModeToggle({ className, dark, light }: DarkModeToggleProps) {
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
    >
      <div id="theme-toggle-dark" className={classNames('flex flex-row gap-2', { hidden: theme === 'dark' })}>
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
        </svg>
        <span>{dark}</span>
      </div>
      <div id="theme-toggle-light" className={classNames('flex flex-row gap-2', { hidden: theme === 'light' })}>
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path
